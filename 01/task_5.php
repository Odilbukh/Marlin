                    ...
                    <div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
                        ...
                        <div class="rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                            ...
                            <div class="ml-2 mr-3">
                                ...
                                <a href="<?=$item['twitter'];?>" class="text-info fs-sm" target="_blank"><?=$item['mail'];?></a> -
                                <a href="<?=$item['email_link'];?>" class="text-info fs-sm" target="_blank" title="<?=$item['contact_tag'];?>"><i class="fal fa-envelope"></i></a>
                            </div>
                        </div>
                       <?php } ?>
                    </div>
