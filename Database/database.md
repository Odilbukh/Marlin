...
sql - SQL запрос (тип строка). В качестве передаваемых данный всегда указываете знак "?". params - массив с параметрами для SQL запроса. В качестве параметров передаётся ключ (имя столбца в базе данных) и значение.
...
Возвращаемые значения: В случае успешного завершения возвращает PDO объект с результатом, а так же со всеми атрибутами или TRUE в случае возникновения ошибки.
...
table - Название таблицы в вазе данных (тип строка). params - массив с параметрами для SQL запроса. В качестве параметров передаётся ключ (имя столбца в базе данных) и значение.

Пример использования:

$params = ['name' => 'user_name', 'email' => 'user_email'];
$users = $db->findALl($table, $params);
...
table - Название таблицы в вазе данных (тип строка). id - индификатор (тип число). params - массив с параметрами для SQL запроса. В качестве параметров передаётся ключ (имя столбца в базе данных) и значение.
...
table - Название таблицы в вазе данных (тип строка). id - индификатор (тип число).
...
table - Название таблицы в вазе данных (тип строка). params - массив с параметрами для SQL запроса. В качестве параметров передаётся:
...
$users = $db->query('SELECT * FROM users ORDER BY name')->first();
...
$users = $db->query('SELECT * FROM users ORDER BY name')->count();
...
$users = $db->query('INSERT INTO users (name, email) VALUES (?,?)', ['name' => 'user_name', 'email' => 'user_email'])->lastID();
